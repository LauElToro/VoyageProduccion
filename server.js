...
const path = require('path');  // Importa el módulo 'path' para manipular rutas
...
if (process.env.NODE_ENV === 'production') {
    // Configura la carpeta 'cliente/build' como el directorio estático
    app.use(express.static(path.join(__dirname, 'cliente/build')));
  
    // Configura la ruta '*' para servir el archivo 'index.html' de la carpeta 'cliente/build'
    app.get('*', (req, res) => {
